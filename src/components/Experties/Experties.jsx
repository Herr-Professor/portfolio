...
import { projectExperience, MyExpertise } from '../../utils/data'
    ...
    <section className={css.wrapper}>
        ...
        className={`paddings yPaddings innerWidth flexCenter ${css.container}`}>
            ...
            className={css.rightSide}>
                ...
                <span className='primaryText'>My Expertise </span>
                {MyExpertise.map((paragraph, i)=> <span className='secondaryText' key={i}>{paragraph}</span>)}
                ...
                <div className={`flexCenter ${css.stats}`}>
                    ...
                    <div className={`flexCenter ${css.stat}`}>
                        ...
                        <span className='secondaryText'>Skills</span>
                    </div>
                </div>
            </motion.div>
        </motion.div>
